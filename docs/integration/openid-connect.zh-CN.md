...
| `none` | None | None | N/A | 不接受 | [RFC 9101 Section 10.5](https://www.rfc-editor.org/rfc/rfc9101.html#section-10.5), [RFC 8725 Section 3.2](https://www.rfc-editor.org/rfc/rfc8725.html#section-3.2) | 受保护 Request Object 表面要求签名；OIDF unsigned 模块 expected skip 是精确白名单。 |
...
| Unsigned Request Objects（`alg=none`） | 不实现 | [RFC 9101 Section 10.5](https://www.rfc-editor.org/rfc/rfc9101.html#section-10.5), [RFC 8725 Section 3.2](https://www.rfc-editor.org/rfc/rfc8725.html#section-3.2) | 受保护 Request Object 表面要求签名；JWT BCP 要求应用只允许满足自身安全要求的算法。 |
