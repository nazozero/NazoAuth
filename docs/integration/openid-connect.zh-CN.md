...
| Pushed Authorization Requests | 完整支持 | [RFC 9126](https://www.rfc-editor.org/rfc/rfc9126.html) | FAPI profile 必需；普通客户端按客户端策略可选。 |
...
| Device Authorization Grant | 可选模块 | [RFC 8628](https://www.rfc-editor.org/rfc/rfc8628.html) | 仅在模块启用且客户端允许该 grant 时宣告。 |
| OpenID CIBA / FAPI-CIBA | 可选模块 | [OpenID CIBA Core](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html), [FAPI-CIBA](https://openid.net/specs/openid-financial-api-ciba.html) | 注册 CIBA 客户端支持 poll 和 ping；不实现 push。 |
...
| OpenID4VCI 1.0 Final | 作为独立默认关闭 Credential Issuer 角色完整支持 | [OpenID4VCI 1.0 Final](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0-final.html) | 不属于普通 OIDC RP 登录；使用独立 credential issuer 元数据和运行模块。 |
| OpenID4VP 1.0 Final | 作为独立默认关闭 Verifier 角色完整支持 | [OpenID4VP 1.0 Final](https://openid.net/specs/openid-4-verifiable-presentations-1_0-final.html) | 不属于普通 OIDC RP 登录；使用独立 verifier 请求/响应处理和运行模块。 |
| OIDC Implicit OP | 按安全策略不实现 | [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 授权端点不通过前通道返回 ID Token 或 access token。 |
| OIDC Hybrid OP | 按安全策略不实现 | [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 交互式流程保持 Authorization Code。 |
| Resource Owner Password Credentials | 按安全策略不实现 | [RFC 6749 Section 4.3](https://www.rfc-editor.org/rfc/rfc6749.html#section-4.3), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 作为不安全 legacy grant 拒绝。 |
| 旧 OIDF Dynamic OP 认证 profile | 按安全策略不实现 | [RFC 7591](https://www.rfc-editor.org/rfc/rfc7591.html), [RFC 7592](https://www.rfc-editor.org/rfc/rfc7592.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 该认证 profile 要求 implicit/hybrid 元数据；RFC 7591/RFC 7592 动态注册仍支持。 |
...
| `software_statement` | 不实现 | [RFC 7591](https://www.rfc-editor.org/rfc/rfc7591.html) | 不暴露 software-statement 信任框架。 |
...
| `HS256`, `HS384`, `HS512` | Symmetric | SHA-256 / SHA-384 / SHA-512 | `sig` | 不支持 | [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518.html) | 不使用共享 client secret 做 OP 响应签名或 Request Object 验证。 |
| `RS384`, `RS512` | RSA | SHA-384 / SHA-512 | `sig` | 不支持 | [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518.html) | 不宣告；应使用已宣告算法。 |
| `ES384`, `ES512` | ECDSA P-384 / P-521 | SHA-384 / SHA-512 | `sig` | 不支持 | [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518.html) | 不宣告；应使用已宣告算法。 |
| `PS384`, `PS512` | RSA-PSS | SHA-384 / SHA-512 | `sig` | 不支持 | [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518.html) | 需要 RSA-PSS 时使用 `PS256`。 |
| `none` | None | None | N/A | 不支持 | [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518.html), [RFC 8725](https://www.rfc-editor.org/rfc/rfc8725.html), [RFC 9101](https://www.rfc-editor.org/rfc/rfc9101.html) | 不实现 unsigned ID Token 和 unsigned Request Object。 |
...
| `none` | None | None | N/A | 不接受 | [RFC 9101](https://www.rfc-editor.org/rfc/rfc9101.html), [RFC 8725](https://www.rfc-editor.org/rfc/rfc8725.html) | 按安全策略拒绝；OIDF unsigned 模块 expected skip 是精确白名单。 |
| `HS*`, `RS384`, `RS512`, `ES384`, `ES512`, `PS384`, `PS512` | Various | Various | `sig` | 不接受 | [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518.html) | discovery 不宣告，客户端元数据/JWK 策略会拒绝。 |
...
| `A128GCM`, `A192GCM` | 不支持 | [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518.html) | 不宣告。 |
| `A128CBC-HS256`, `A192CBC-HS384`, `A256CBC-HS512` | 不支持 | [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518.html) | 不宣告。 |
...
| Implicit ID Token | 不实现 | `id_token` | [OpenID Connect Core](https://openid.net/specs/openid-connect-core-1_0.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 按安全策略不实现。 |
| Implicit Access Token | 不实现 | `token` | [RFC 6749](https://www.rfc-editor.org/rfc/rfc6749.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 按安全策略不实现。 |
| Implicit ID Token + Access Token | 不实现 | `id_token token` | [OpenID Connect Core](https://openid.net/specs/openid-connect-core-1_0.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 按安全策略不实现。 |
| Hybrid Code + ID Token | 不实现 | `code id_token` | [OpenID Connect Core](https://openid.net/specs/openid-connect-core-1_0.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 按安全策略不实现。 |
| Hybrid Code + Token | 不实现 | `code token` | [OpenID Connect Core](https://openid.net/specs/openid-connect-core-1_0.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 按安全策略不实现。 |
| Hybrid Code + ID Token + Token | 不实现 | `code id_token token` | [OpenID Connect Core](https://openid.net/specs/openid-connect-core-1_0.html), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | 按安全策略不实现。 |
...
| Form Post JARM | 不实现 | `form_post.jwt` | [JARM](https://openid.net/specs/oauth-v2-jarm.html) | N/A | 不宣告；JARM 使用 `jwt`，plain code form-post 使用 `form_post`。 |
| Query JARM | 不实现 | `query.jwt` | [JARM](https://openid.net/specs/oauth-v2-jarm.html) | N/A | 不作为独立 response mode 宣告。 |
| Fragment JARM | 不实现 | `fragment.jwt` | [JARM](https://openid.net/specs/oauth-v2-jarm.html) | N/A | 不宣告。 |
...
| `urn:ietf:params:oauth:grant-type:device_code` | 可选 | [RFC 8628](https://www.rfc-editor.org/rfc/rfc8628.html) | Device Authorization Grant 模块启用且客户端 allowlist 包含 | 禁用时不宣告。 |
| OpenID CIBA grant | 可选 | [OpenID CIBA Core](https://openid.net/specs/openid-client-initiated-backchannel-authentication-core-1_0.html) | CIBA 模块启用且客户端注册 poll 或 ping delivery | 不实现 push delivery mode。 |
...
| `password` | 不实现 | [RFC 6749 Section 4.3](https://www.rfc-editor.org/rfc/rfc6749.html#section-4.3), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | N/A | 按安全策略不实现。 |
| `implicit` | 不实现 | [RFC 6749 Section 4.2](https://www.rfc-editor.org/rfc/rfc6749.html#section-4.2), [RFC 9700](https://www.rfc-editor.org/rfc/rfc9700.html) | N/A | 按安全策略不实现。 |
...
| `attest_jwt_client_auth` | 可选 | [OAuth Client Attestation draft](https://datatracker.ietf.org/doc/draft-ietf-oauth-attestation-based-client-auth/) | Client Attestation 模块启用且客户端策略要求 | 仅在运行模块启用时宣告。 |
...
实现的是安全的 RFC 7591 / RFC 7592 动态客户端注册，但不实现 legacy OIDF Dynamic OP certification profile。该 profile 要求 implicit 和 hybrid flow 的 discovery 元数据，这些能力按安全策略不实现。
...
这些是安全策略决定，不是隐藏配置开关。不要尝试用未公开部署选项重新启用。
