...
- `crates/authorization-server/tests/source_mounted/src/bootstrap/tests/cors.rs`
- `crates/authorization-server/tests/source_mounted/src/http/authorization/tests/*`
...
- `crates/authorization-server/src/http/well_known.rs`
- `crates/authorization-server/tests/source_mounted/src/http/tests/dynamic_client_registration.rs`
- `docs/operations/configuration.md`
- `docs/protocol/profile-matrix.md`
...
- `crates/authorization-server/tests/source_mounted/src/http/token/tests/token_exchange.rs`
- `crates/authorization-server/tests/source_mounted/src/http/token/tests/jwt_bearer.rs`
...
- `crates/authorization-server/tests/source_mounted/src/http/profile/tests/*` 或新增 `crates/authorization-server/tests/source_mounted/src/http/external_login/tests/*`
- `docs/operations/configuration.md`
- `docs/protocol/profile-matrix.md`
...
- `crates/authorization-server/src/http/well_known.rs`
- `crates/authorization-server/src/settings/profile.rs`
- `crates/authorization-server/tests/source_mounted/src/http/token/tests/ciba.rs`
- `crates/authorization-server-core/tests/metadata.rs`
