...
- `crates/server/src/bootstrap/routes.rs`
- `crates/server/src/config.rs`
- `crates/server/src/settings.rs`
- `crates/server/tests/in_source/src/bootstrap/tests/cors.rs`
- `crates/server/tests/in_source/src/http/authorization/tests/*`
...
| 子项 | 当前事实源 | M2 状态 |
| --- | --- | --- |
| FAPI2 Security Final | `fapi2-security` runtime profile 已强制 PAR、S256、confidential client、FAPI client auth、sender-constrained token、code TTL 与 PAR TTL；`crates/server/tests/in_source/src/http/authorization/tests/par.rs`、`crates/server/tests/in_source/src/http/token/tests/dispatch.rs` 和 `crates/server/tests/in_source/src/http/tests/well_known.rs` 保持对应负向测试。 | 已由官方 `oidf-conformance-full.yml` run `28953799865` 在 18+2 `parallel-isolated` 矩阵中验证。 |
| Signed request object | `fapi2-message-signing-authz-request` 独立 profile 要求 PAR 中 signed request object；`crates/server/src/http/authorization/jar.rs` 与 PAR/JAR 测试覆盖 `aud`、`nbf`、`exp`、client 绑定和 replay 边界。 | profile-scoped；不并入 base `fapi2-security`。 |
...
- `crates/server/src/http/authorization/*`
- `crates/server/src/http/token/introspect.rs`
- `crates/server/src/http/well_known.rs`
- `crates/server/src/settings/profile.rs`
- `crates/server/tests/in_source/src/http/authorization/tests/*`
- `crates/server/tests/in_source/src/http/token/tests/introspect.rs`
- `crates/server/tests/in_source/src/http/tests/well_known.rs`
...
- `crates/server/src/http/dynamic_client_registration.rs`
- `crates/server/src/http/admin/clients/create.rs`
- `crates/server/src/http/well_known.rs`
- `crates/server/tests/in_source/src/http/tests/dynamic_client_registration.rs`
- `docs/operations/configuration.md`
- `docs/protocol/profile-matrix.md`
...
- `crates/server/src/http/token/token_exchange.rs`
- `crates/server/src/http/token/jwt_bearer.rs`
- `crates/server/src/http/token/dispatch.rs`
- `crates/server/tests/in_source/src/http/token/tests/token_exchange.rs`
- `crates/server/tests/in_source/src/http/token/tests/jwt_bearer.rs`
...
- `crates/server/src/http/profile/*` 或新增 `crates/server/src/http/external_login/*`
- `crates/server/src/settings.rs`
- `crates/server/src/settings/profile.rs`
- `crates/server/src/bootstrap/routes.rs`
- `crates/server/src/http/well_known.rs` 之外的 RP 配置文档；第三方登录不应进入 OP Discovery metadata
- `crates/server/tests/in_source/src/http/profile/tests/*` 或新增 `crates/server/tests/in_source/src/http/external_login/tests/*`
- `docs/operations/configuration.md`
- `docs/protocol/profile-matrix.md`
...
- `crates/server/src/http/token/ciba.rs`
- `crates/server/src/http/token/dispatch.rs`
- `crates/server/src/http/well_known.rs`
- `crates/server/src/settings/profile.rs`
- `crates/server/tests/in_source/src/http/token/tests/ciba.rs`
- `crates/server/tests/in_source/src/http/tests/well_known.rs`
