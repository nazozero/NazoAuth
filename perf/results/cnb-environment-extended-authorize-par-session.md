...
| Compose project | nazoauth-extended-capacity-extended-authorize-par-session |
| Compose files | docker-compose.perf.yml + perf/results/docker-compose.cpuset-extended-authorize-par-session.yml |
| CPU set | 179-184 |
| CPU set size | 6 |
...
| Capacity scenarios | authorize_par_session |
