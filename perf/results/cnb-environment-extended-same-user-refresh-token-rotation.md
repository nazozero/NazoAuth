...
| Compose files | docker-compose.perf.yml + perf/results/docker-compose.cpuset-extended-same-user-refresh-token-rotation.yml |
| CPU set | 203-208 |
| CPU set size | 6 |
...
| Capacity scenarios | same_user_refresh_token_rotation |
