...
| Compose project | nazoauth-local-oidc-cold-login-short |
| Compose files | docker-compose.perf.yml + perf/results/docker-compose.cpuset-oidc-cold-login-short.yml |
