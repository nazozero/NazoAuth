...
| Compose project | nazoauth-local-fapi2-logged-in-high-security |
| Compose files | docker-compose.perf.yml + perf/results/docker-compose.cpuset-fapi2-logged-in-high-security.yml |
