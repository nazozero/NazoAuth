...
async fn upsert_user(connection: &mut AsyncPgConnection, user: &OidfSeedUser) -> QueryResult<()> {
    sql_query(
        ...
        VALUES (
            ...
            'Conformance',
            'oidf',
            'https://issuer.example/profile/oidf-local',
            'https://issuer.example/avatar/oidf-local.png',
        ...
        SET password_hash = EXCLUDED.password_hash,
            ...
            nickname = 'oidf',
            profile_url = 'https://issuer.example/profile/oidf-local',
            avatar_url = 'https://issuer.example/avatar/oidf-local.png',
