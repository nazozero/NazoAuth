...
async fn federation_provider_list(state: Data<TestInfrastructure>) -> HttpResponse {
...
fn oidc_callback_state() -> TestInfrastructure {
...
fn provider_list_state() -> TestInfrastructure {
